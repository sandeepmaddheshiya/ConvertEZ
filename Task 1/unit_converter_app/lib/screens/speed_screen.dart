  ...
  void _calculate() {
    setState(() {
      if (_textEditingController1.text == optionsTexts[0] &&
        ...
        _result = double.parse(_textEditingController0.text) * 0.0003;
      } else if (_textEditingController1.text == optionsTexts[0] &&
          _textEditingController2.text == optionsTexts[2]) {
        _result = double.parse(_textEditingController0.text) * 0.6214;
      } else if (_textEditingController1.text == optionsTexts[0] &&
        ...
        _result = double.parse(_textEditingController0.text) * 0.2778;
      } //2nd
      else if (_textEditingController1.text == optionsTexts[1] &&
          _textEditingController2.text == optionsTexts[0]) {
        _result = double.parse(_textEditingController0.text) * 3600;
      } else if (_textEditingController1.text == optionsTexts[1] &&
          _textEditingController2.text == optionsTexts[1]) {
        _result = double.parse(_textEditingController0.text) * 1;
      } else if (_textEditingController1.text == optionsTexts[1] &&
          _textEditingController2.text == optionsTexts[2]) {
        _result = double.parse(_textEditingController0.text) * 2236.9363;
      } else if (_textEditingController1.text == optionsTexts[1] &&
          _textEditingController2.text == optionsTexts[3]) {
        _result = double.parse(_textEditingController0.text) * 0.6214;
      } else if (_textEditingController1.text == optionsTexts[1] &&
        ...
        _result = double.parse(_textEditingController0.text) * 1000;
          ...
          _textEditingController2.text == optionsTexts[0]) {
        _result = double.parse(_textEditingController0.text) * 1.6093;
      } else if (_textEditingController1.text == optionsTexts[2] &&
          _textEditingController2.text == optionsTexts[1]) {
        _result = double.parse(_textEditingController0.text) * 0.0004;
      } else if (_textEditingController1.text == optionsTexts[2] &&
          _textEditingController2.text == optionsTexts[2]) {
        _result = double.parse(_textEditingController0.text) * 1;
      } else if (_textEditingController1.text == optionsTexts[2] &&
        ...
        _result = double.parse(_textEditingController0.text) * 0.0003;
          ...
          _textEditingController2.text == optionsTexts[4]) {
        _result = double.parse(_textEditingController0.text) * 0.447;
      } //4th
      else if (_textEditingController1.text == optionsTexts[3] &&
          _textEditingController2.text == optionsTexts[0]) {
        _result = double.parse(_textEditingController0.text) * 5793.6384;
      } else if (_textEditingController1.text == optionsTexts[3] &&
          _textEditingController2.text == optionsTexts[1]) {
        _result = double.parse(_textEditingController0.text) * 1.6093;
      } else if (_textEditingController1.text == optionsTexts[3] &&
        ...
        _result = double.parse(_textEditingController0.text) * 1;
          ...
          _textEditingController2.text == optionsTexts[4]) {
        _result = double.parse(_textEditingController0.text) * 1609.344;
      } //5th
      else if (_textEditingController1.text == optionsTexts[4] &&
          _textEditingController2.text == optionsTexts[0]) {
        _result = double.parse(_textEditingController0.text) * 3.6;
      } else if (_textEditingController1.text == optionsTexts[4] &&
          _textEditingController2.text == optionsTexts[1]) {
        _result = double.parse(_textEditingController0.text) * 0.001;
      } else if (_textEditingController1.text == optionsTexts[4] &&
          _textEditingController2.text == optionsTexts[2]) {
        _result = double.parse(_textEditingController0.text) * 2.2369;
      } else if (_textEditingController1.text == optionsTexts[4] &&
          _textEditingController2.text == optionsTexts[3]) {
        _result = double.parse(_textEditingController0.text) * 0.0006;
      } else if (_textEditingController1.text == optionsTexts[4] &&
          _textEditingController2.text == optionsTexts[4]) {
        _result = double.parse(_textEditingController0.text) * 1;
      }
